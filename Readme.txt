...
->Class Node: is implemented that contains the data structure required for a transaction
	-data structure used:
		...
		.transaction	 = a log that is written during the transfer of money between sender and receiver and is stored securely(unreadable) in the system
...
5) Show users : display the current users in the system
